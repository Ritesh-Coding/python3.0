    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('passing_year', models.IntegerField(validators=[django.core.validators.RegexValidator(code='invalid_registration', message='Enter a valid Passing Year.', regex='^(19\\d{2}|20[0-9]{2})$')])),
