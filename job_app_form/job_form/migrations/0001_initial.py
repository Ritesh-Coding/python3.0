    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cities', models.CharField(blank=True, max_length=20, null=True)),
                ('states', models.CharField(max_length=25)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='job_form.basicdetails')),
            ],
        ),
        migrations.CreateModel(
            name='Preference',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='job_form.basicdetails')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level_of_expertise', models.CharField(choices=[('beginner', 'Begineer'), ('mediator', 'Mediator'), ('expertise', 'Expertise')], max_length=9)),
                ('employee_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='job_form.basicdetails')),
            ],
        ),
        migrations.CreateModel(
